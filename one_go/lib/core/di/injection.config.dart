...
import 'package:one_go/features/auth/data/repositories/auth_repository.dart'
    as _i272;
import 'package:one_go/features/auth/data/repositories/mock_auth_repository.dart'
    as _i650;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i650.AuthRepository>(
        () => _i650.MockAuthRepositoryImpl(gh<_i361.Dio>()));
